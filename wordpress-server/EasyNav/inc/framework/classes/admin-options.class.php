...
font-size: 25px;font-weight: 800;background-image: linear-gradient(to right , #0DACB7, #71bd6a);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">EasyNav</asa> <small>by www.mubanniao.com</small>',
      'framework_class'         => '',
    ...
    public function add_admin_footer_text() {
      $default = '感谢您在Wordpress使用主题 <a href="https://gitee.com/MUCEO/EasyNav/" target="_blank">EasyNav</a>进行写作 <a href="https://mubanniao.com/" target="_blank">作者官网</a>';
      ...
      echo '<div class="csf csf-options'. esc_attr( $theme . $class . $wrapper_class ) .'" data-slug="'. esc_attr( $this->args['menu_slug'] ) .'" data-unique="'. esc_attr( $this->unique ) .'">';
        ...
        echo '<div class="csf-header-inner">';
          ...
          echo '<div class="csf-header-right">';
            ...
            echo ( $this->args['show_search'] ) ? '<div class="csf-search"><input type="txt" name="csf-search" placeholder="'. esc_html__( 'Search...', 'csf' ) .'" autocomplete="off" autocomplete="new-password" /></div>' : '';
